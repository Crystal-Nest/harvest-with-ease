...
public final class ModConfig extends CommonConfig {
   ...
   */
  private ModConfigSpec.DoubleValue exhaustionMultiplier;
  ...
  protected void define(ModConfigSpec.Builder builder) {
    ...
    crops = builder.comment(" List of in-game IDs of additional crops that are not supported out of the box.").defineListAllowEmpty("crops", List.of("neapolitan:adzuki_sprouts"), this::stringListValidator);
    ...
    requireHoe = builder.comment(" Whether holding a hoe (either hands) is required to right-click harvest.").define("require hoe", false);
